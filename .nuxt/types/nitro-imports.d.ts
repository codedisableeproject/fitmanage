declare global {
  ...
  const classAttendance: typeof import('../../server/utils/dummyData').classAttendance
  ...
  const createPosProduct: typeof import('../../server/utils/dummyData').createPosProduct
  const createRouter: typeof import('../../node_modules/h3').createRouter
  const dashboardSummary: typeof import('../../server/utils/dummyData').dashboardSummary
  ...
  const gymProfile: typeof import('../../server/utils/dummyData').gymProfile
  const handleCacheHeaders: typeof import('../../node_modules/h3').handleCacheHeaders
  const handleCors: typeof import('../../node_modules/h3').handleCors
  const instructors: typeof import('../../server/utils/dummyData').instructors
  ...
  const members: typeof import('../../server/utils/dummyData').members
  const nitroPlugin: typeof import('../../node_modules/nitropack/dist/runtime/internal/plugin').nitroPlugin
  const packages: typeof import('../../server/utils/dummyData').packages
  const parseCookies: typeof import('../../node_modules/h3').parseCookies
  const posProducts: typeof import('../../server/utils/dummyData').posProducts
  const promisifyNodeListener: typeof import('../../node_modules/h3').promisifyNodeListener
  const proxyOrDummy: typeof import('../../server/utils/proxyOrDummy').proxyOrDummy
  ...
  const revenueTrend: typeof import('../../server/utils/dummyData').revenueTrend
  const runTask: typeof import('../../node_modules/nitropack/dist/runtime/internal/task').runTask
  const sanitizeStatusCode: typeof import('../../node_modules/h3').sanitizeStatusCode
  const sanitizeStatusMessage: typeof import('../../node_modules/h3').sanitizeStatusMessage
  const schedule: typeof import('../../server/utils/dummyData').schedule
  ...
  const transactions: typeof import('../../server/utils/dummyData').transactions
  const unsealSession: typeof import('../../node_modules/h3').unsealSession
  const updateGymProfile: typeof import('../../server/utils/dummyData').updateGymProfile
...
declare global {
  ...
  // @ts-ignore
  export type { Member, MembershipPackage, Transaction, ScheduleClass, ClassAttendance, GymProfile, PosProduct, Instructor } from '../../server/utils/dummyData'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'D:/aplikasi-lain/nuxt/fitmanage/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'D:/aplikasi-lain/nuxt/fitmanage/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { members, packages, transactions, schedule, dashboardSummary, revenueTrend, classAttendance, gymProfile, updateGymProfile, posProducts, createPosProduct, instructors } from 'D:/aplikasi-lain/nuxt/fitmanage/server/utils/dummyData';
export { proxyOrDummy } from 'D:/aplikasi-lain/nuxt/fitmanage/server/utils/proxyOrDummy';